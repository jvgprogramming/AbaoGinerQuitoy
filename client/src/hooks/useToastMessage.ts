...
export const useToastMessage = (initialMessage: string, initialIsFailed: boolean = false, initialIsVisible: boolean) => {
...
return{
    message, isVisible, isFailed, showToastMessage, closeToastMessage, toggleToastMessage
    };
};
